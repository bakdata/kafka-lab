...
package com.bakdata.uni.range.padder;
...
public interface ZeroPadder<T> {
    ...
    /**
     * The implementation of this method should return the end of the range. The end of the
     * range could be exclusive or inclusive.
     */
